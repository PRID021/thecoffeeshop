        ...
        VStack(alignment: .leading, spacing: 0){
            ...
            Group {
                ...
                HStack{
                    ...
                    .padding(.vertical,8)
                    .background(RoundedRectangle(cornerRadius: 32).stroke(style: /*@START_MENU_TOKEN@*/StrokeStyle()/*@END_MENU_TOKEN@*/))
            ...
            Group{
                ...
                .background(RoundedRectangle(cornerRadius: 32).stroke(style: StrokeStyle(lineWidth: 1)).foregroundColor(Color.onBackground))
                .padding(.bottom, 16)
