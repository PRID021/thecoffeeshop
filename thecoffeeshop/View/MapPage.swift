...
struct MapPage: View {
    ...
    let steps = [
        TextView(text: "Repair Your Order", font: Font.system(size: 12, weight: Font.Weight.regular)),
        TextView(text: "Shipping To Transport", font: Font.system(size: 12, weight: Font.Weight.regular)),
        TextView(text: "Order On Delivering", font: Font.system(size: 12, weight: Font.Weight.regular)),
        TextView(text: "Payment", font: Font.system(size: 12, weight: Font.Weight.regular))
    ]
    ...
    let indicators = [
        ...
        StepperIndicationType.custom(Image(systemName:"4.circle").font(.largeTitle).eraseToAnyView())
    ]
